...
public class Submarine extends javax.swing.JFrame implements DefenceObserver {
    ...
    private void OxygenChange() {
        ...
        oxygenTimer = new javax.swing.Timer(4500, new java.awt.event.ActionListener() {
            int direction = 1;

            @Override
            public void actionPerformed(java.awt.event.ActionEvent e) {
                int currentOxygen = jSlider1.getValue(); // oxygen level slider එක

                int usage = (int) (Math.random() * 2) + 1; // random 1–2% usage

                if (currentOxygen > 0) {
                    int newOxygen = Math.max(currentOxygen - usage, 0);
                    jSlider1.setValue(newOxygen);
                    jLabel16.setText("Oxygen Level: " + newOxygen + " %");
                }

                if (jSlider1.getValue() <= 20) {
                    ((javax.swing.Timer) e.getSource()).stop();
                    jLabel16.setForeground(new java.awt.Color(255, 80, 80));
                    jLabel16.setText("Oxygen Critical! Ascending to Surface...");
                }
            }
        });
    ...
    private void EnergyDecrease() {
        ...
        energyTimer = new javax.swing.Timer(1500, new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                ...
                if (jSlider2.getValue() <= 20) {
                    ((javax.swing.Timer) e.getSource()).stop();
                    jLabel16.setText("Energy Cells Exhausted! Returning to Base...");
                }
            }
        });
    ...
    private void initComponents() {
        ...
        jLabel16.setForeground(new java.awt.Color(0, 200, 0));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        mainController.setSubMessage(message);
