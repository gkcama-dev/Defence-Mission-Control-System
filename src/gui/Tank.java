...
public class Tank extends javax.swing.JFrame implements DefenceObserver {
    ...
    private void FuelDecrease() {
        ...
        fuelTimer = new javax.swing.Timer(1500, new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                int currentFuel = jSlider1.getValue();

                int consumption = (int) (Math.random() * 3) + 1;

                if (currentFuel > 0) {
                    int newFuel = Math.max(currentFuel - consumption, 0);
                    jSlider1.setValue(newFuel);
                }

                if (jSlider1.getValue() <= 20) {
                    ((javax.swing.Timer) e.getSource()).stop();
                    jLabel16.setText("Fuel Depleted! Returning to Base for Refuel...");
                }
            }
        });
    ...
    private void SpeedChange() {
        ...
        speedTimer = new javax.swing.Timer(800, new java.awt.event.ActionListener() {
            int direction = 1;

            @Override
            public void actionPerformed(java.awt.event.ActionEvent e) {
                int currentSpeed = jSlider2.getValue(); 
                int step = (int) (Math.random() * 4) + 1; 

                
                if (currentSpeed >= 80) {
                    direction = -1; // slow down
                } else if (currentSpeed <= jSlider2.getMinimum() + 5) {
                    direction = 1; // speed up
                }

                
                jSlider2.setValue(currentSpeed + (direction * step));

               
                jLabel16.setText("Speed: " + jSlider2.getValue() + " km/h");
            }
        });
    ...
    private void initComponents() {
        ...
        jButton2.setText("Radar Operation");
        ...
        jLabel16.setForeground(new java.awt.Color(255, 128, 0));
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icons8-ammo-30.png"))); // NOI18N
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        mainController.setTankMessage(message);
